"""Regression checks for the apex-plat-compose-mesh casebook."""
...
from casebook.harness import assert_expected, apex_plat_compose_mesh_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(apex_plat_compose_mesh_summary(), assert_expected())
